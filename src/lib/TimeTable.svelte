...
<div class="w-full {isMobile ? 'p-0 m-0 bg-transparent' : 'max-w-5xl mx-auto my-3 md:my-5 p-3 md:p-5 bg-white rounded-xl'}">
  ...
  <div class="md:hidden mb-2">
    <div class="flex justify-center gap-2 mb-2">
      <button 
        class="px-2 py-1 bg-blue-100 hover:bg-blue-200 text-blue-800 rounded-lg text-xs transition-colors"
      ...
      <select 
        class="px-2 py-1 bg-gray-100 border border-gray-300 rounded-lg text-xs"
        on:change={(e) => {
  ...
  <div class="overflow-x-auto {isMobile ? 'rounded-lg' : 'rounded-xl'}">
    <table class="w-full border-separate border-spacing-0 mb-2 md:mb-5 text-center overflow-hidden">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="p-1 md:p-3 border-[0.5px] border-gray-200 text-center"></td>
          <td class="p-1 md:p-3 border-[0.5px] border-gray-200 text-center">
            <div class="text-[9px] md:text-sm text-center">데이터베이스실무(A)</div>
            <div class="flex items-center justify-center mt-0.5 md:mt-1">
              <span class="text-[8px] md:text-xs bg-blue-50 text-gray-600 px-1 md:px-2 py-0.5 rounded-full border border-blue-100">창조관 전산712</span>
              <span class="w-1 h-1 md:w-2 md:h-2 rounded-full bg-red-500 ml-0.5 md:ml-1"></span>
            </div>
          </td>
          <td class="p-1 md:p-3 border-[0.5px] border-gray-200 text-center">
            <div class="text-[9px] md:text-sm text-center">성서의지혜(A)</div>
            <div class="flex items-center justify-center mt-0.5 md:mt-1">
              <span class="text-[8px] md:text-xs bg-blue-50 text-gray-600 px-1 md:px-2 py-0.5 rounded-full border border-blue-100">창조관 미디610</span>
              <span class="w-1 h-1 md:w-2 md:h-2 rounded-full bg-green-500 ml-0.5 md:ml-1"></span>
            </div>
          </td>
          <td class="p-1 md:p-3 border-[0.5px] border-gray-200 text-center">
            <div class="text-[9px] md:text-sm text-center">UI/UX실무(A)</div>
            <div class="flex items-center justify-center mt-0.5 md:mt-1">
              <span class="text-[8px] md:text-xs bg-blue-50 text-gray-600 px-1 md:px-2 py-0.5 rounded-full border border-blue-100">창조관 702</span>
              <span class="w-1 h-1 md:w-2 md:h-2 rounded-full bg-blue-500 ml-0.5 md:ml-1"></span>
            </div>
          </td>
          <td class="p-1 md:p-3 border-[0.5px] border-gray-200 text-center">
            <div class="text-[9px] md:text-sm text-center">파이썬(A)</div>
            <div class="flex items-center justify-center mt-0.5 md:mt-1">
              <span class="text-[8px] md:text-xs bg-blue-50 text-gray-600 px-1 md:px-2 py-0.5 rounded-full border border-blue-100">창조관 전산712</span>
              <span class="w-1 h-1 md:w-2 md:h-2 rounded-full bg-red-500 ml-0.5 md:ml-1"></span>
            </div>
        ...
        <tr>
          ...
          <td class="p-1 md:p-3 border-[0.5px] border-gray-200 text-center">
            ...
            <div class="flex items-center justify-center mt-0.5 md:mt-1">
              <span class="text-[8px] md:text-xs bg-blue-50 text-gray-600 px-1 md:px-2 py-0.5 rounded-full border border-blue-100">백석홀(대)</span>
        ...
        <tr>
          ...
          <td class="p-1 md:p-3 border-[0.5px] border-gray-200 text-center">
            {#if isServiceClass(currentDate)}
              <div class="text-[9px] md:text-sm text-center">서비스인성(A)</div>
              <div class="flex items-center justify-center mt-0.5 md:mt-1">
                <span class="text-[8px] md:text-xs bg-blue-50 text-gray-600 px-1 md:px-2 py-0.5 rounded-full border border-blue-100">
                  {davinci.includes(currentDate) ? '백석홀 소강당' : '창조관 610'}
                </span>
                <span class="w-1 h-1 md:w-2 md:h-2 rounded-full bg-gray-400 ml-0.5 md:ml-1"></span>
              </div>
              <div class="text-[8px] md:text-xs text-amber-600 mt-0.5 md:mt-1">
                {davinci.includes(currentDate) ? '다빈치' : '서비스인성'}
              </div>
            {:else}
              <div class="text-[9px] md:text-sm text-gray-400 text-center">/</div>
            {/if}
          </td>
          <td class="p-1 md:p-3 border-[0.5px] border-gray-200 text-center"></td>
          <td class="p-1 md:p-3 border-[0.5px] border-gray-200 text-center"></td>
        ...
        <tr>
          ...
          <td class="p-1 md:p-3 border-[0.5px] border-gray-200 text-center"></td>
          <td class="p-1 md:p-3 border-[0.5px] border-gray-200 text-center">
            <div class="text-[9px] md:text-sm text-center">자바기초(A)</div>
            <div class="flex items-center justify-center mt-0.5 md:mt-1">
          ...
          <td class="p-1 md:p-3 border-[0.5px] border-gray-200 text-center"></td>
          <td class="p-1 md:p-3 border-[0.5px] border-gray-200 text-center">
            <div class="text-[9px] md:text-sm text-center">하드웨어실습(A)</div>
            <div class="flex items-center justify-center mt-0.5 md:mt-1">
        ...
        <tr>
          ...
          <td class="p-1 md:p-3 border-[0.5px] border-gray-200 text-center">
            <div class="text-[9px] md:text-sm text-center">자기개발(A)</div>
            <div class="flex items-center justify-center mt-0.5 md:mt-1">
              <span class="text-[8px] md:text-xs bg-blue-50 text-gray-600 px-1 md:px-2 py-0.5 rounded-full border border-blue-100">창조관 미디610</span>
              <span class="w-1 h-1 md:w-2 md:h-2 rounded-full bg-cyan-500 ml-0.5 md:ml-1"></span>
            </div>
          </td>
          <td class="p-1 md:p-3 border-[0.5px] border-gray-200 text-center">
            <div class="text-[9px] md:text-sm text-center">하드웨어실습(A)</div>
  ...
  <div class="md:hidden flex justify-center gap-1 mb-2">
    <button 
      class="px-2 py-1 bg-amber-100 hover:bg-amber-200 text-amber-800 rounded-lg transition-colors text-xs flex items-center"
      on:click={() => showNotice = !showNotice}
    >
      <span>{showNotice ? '공지 숨기기' : '공지 보기'}</span>
      <span class="ml-1">{showNotice ? '▲' : '▼'}</span>
    </button>
    
    <button 
      class="px-2 py-1 bg-gray-100 hover:bg-gray-200 text-gray-800 rounded-lg transition-colors text-xs flex items-center"
      on:click={() => showDetails = !showDetails}
    >
  ...
  <!-- 서비스인성 관련 공지 -->
  {#if showNotice}
    <div class="bg-amber-50 border-[0.5px] border-amber-200 p-2 md:p-4 rounded-lg md:rounded-xl mb-2 md:mb-5 transition-all duration-300 text-xs md:text-base">
      <h3 class="font-bold text-sm md:text-lg text-gray-800 mb-1 md:mb-2">서비스인성 관련 공지 정리</h3>
      
      <p class="mb-1 md:mb-2"><strong>수요일 5교시</strong>: 서비스인성 교과목 진행</p>
      
      <h4 class="font-bold text-xs md:text-md text-amber-800 mt-1 md:mt-3 mb-0.5 md:mb-1">다빈치아카데미 일정 (총 3회)</h4>
      <ul class="list-disc pl-4 md:pl-5 mb-1 md:mb-3">
        <li><strong>날짜</strong>: 3/26, 4/2, 4/9</li>
        <li><strong>장소</strong>: 백석홀 소강당</li>
        <li><strong>시간</strong>: 13:30까지 도착</li>
      </ul>
      
      <h4 class="font-bold text-xs md:text-md text-amber-800 mt-1 md:mt-3 mb-0.5 md:mb-1">서비스인성아카데미 일정 (총 6회)</h4>
  ...
  <!-- 강의 상세 정보 -->
  {#if showDetails}
    <div class="bg-gray-50 border-[0.5px] border-gray-200 p-2 md:p-4 rounded-lg md:rounded-xl transition-all duration-300 text-xs md:text-base">
      <h3 class="font-bold text-sm md:text-lg text-gray-800 mb-1 md:mb-3">강의 상세 정보</h3>
      
      <div class="grid grid-cols-1 md:grid-cols-2 gap-1 md:gap-2">
        <div class="flex items-center">
          <span class="w-1 h-1 md:w-2 md:h-2 rounded-full bg-red-500 mr-1 md:mr-2"></span>
          <span>데이터베이스실무(A) - 교수: 김경희</span>
        </div>
        
        <div class="flex items-center">
          <span class="w-1 h-1 md:w-2 md:h-2 rounded-full bg-green-500 mr-1 md:mr-2"></span>
          <span>성서의지혜(A) - 교수: 김은태</span>
        </div>
        
        <div class="flex items-center">
          <span class="w-1 h-1 md:w-2 md:h-2 rounded-full bg-blue-500 mr-1 md:mr-2"></span>
          <span>UI/UX실무(A) - 교수: 김용숙</span>
        </div>
        
        <div class="flex items-center">
          <span class="w-1 h-1 md:w-2 md:h-2 rounded-full bg-purple-500 mr-1 md:mr-2"></span>
          <span>채플(A) - 교수: 최유석</span>
        </div>
        
        <div class="flex items-center">
          <span class="w-1 h-1 md:w-2 md:h-2 rounded-full bg-orange-500 mr-1 md:mr-2"></span>
          <span>자바기초(A) - 교수: 박현수</span>
        </div>
        
        <div class="flex items-center">
          <span class="w-1 h-1 md:w-2 md:h-2 rounded-full bg-cyan-500 mr-1 md:mr-2"></span>
          <span>자기개발(A) - 교수: 김정연</span>
        </div>
        
        <div class="flex items-center">
          <span class="w-1 h-1 md:w-2 md:h-2 rounded-full bg-violet-500 mr-1 md:mr-2"></span>
      ...
      <div class="mt-2 md:mt-4 pt-2 md:pt-4 border-t border-gray-200">
        ...
        <div class="flex flex-wrap gap-1 md:gap-3">
          <div class="flex items-center"><span class="w-1 h-1 md:w-2 md:h-2 rounded-full bg-red-500 mr-0.5 md:mr-1"></span> 김경희</div>
          <div class="flex items-center"><span class="w-1 h-1 md:w-2 md:h-2 rounded-full bg-green-500 mr-0.5 md:mr-1"></span> 김은태</div>
          <div class="flex items-center"><span class="w-1 h-1 md:w-2 md:h-2 rounded-full bg-blue-500 mr-0.5 md:mr-1"></span> 김용숙</div>
          <div class="flex items-center"><span class="w-1 h-1 md:w-2 md:h-2 rounded-full bg-purple-500 mr-0.5 md:mr-1"></span> 최유석</div>
          <div class="flex items-center"><span class="w-1 h-1 md:w-2 md:h-2 rounded-full bg-orange-500 mr-0.5 md:mr-1"></span> 박현수</div>
          <div class="flex items-center"><span class="w-1 h-1 md:w-2 md:h-2 rounded-full bg-cyan-500 mr-0.5 md:mr-1"></span> 김정연</div>
          <div class="flex items-center"><span class="w-1 h-1 md:w-2 md:h-2 rounded-full bg-violet-500 mr-0.5 md:mr-1"></span> 김민영</div>
          <div class="flex items-center"><span class="w-1 h-1 md:w-2 md:h-2 rounded-full bg-gray-400 mr-0.5 md:mr-1"></span> 미지정</div>
        </div>
      </div>
    </div>
  {/if}
